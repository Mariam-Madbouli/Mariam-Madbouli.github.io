...
//  Variable To Control The Background Interavel
let backgroundInterval;

// Check If There's LocalStorage Random Background Items
let backgroundLocalItem = localStorage.getItem("background-option");

// Check If Random Backgrond Local Storage Is Not Empty
if (backgroundLocalItem !== null) {
    ...
    document.querySelectorAll(".random-backgronds span").forEach(element => {
...
// Click On Toggle settinges Gear              Toggle Spin class on Icon
